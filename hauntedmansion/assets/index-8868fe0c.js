 ...
 */ const Wr = "157",
  Rn = { LEFT: 0, MIDDLE: 1, RIGHT: 2, ROTATE: 0, DOLLY: 1, PAN: 2 },
...
const Al = {
  ...
  ceilPowerOfTwo: Tl,
  floorPowerOfTwo: qi,
  setQuaternionFromProperEuler: yl,
  normalize: pt,
  denormalize: Yn,
};
class Ne {
  ...
  static sRGBToLinear(e) {
    if (
      ...
      const r = n.getImageData(0, 0, e.width, e.height),
        s = r.data;
      for (let o = 0; o < s.length; o++) s[o] = Zn(s[o] / 255) * 255;
...
class xt extends An {
  ...
  get encoding() {
    return (
      ...
      this.colorSpace === at ? Mn : Va
    );
  }
  set encoding(e) {
    hi("THREE.Texture: Property .encoding has been replaced by .colorSpace."),
      (this.colorSpace = e === Mn ? at : wt);
  }
}
xt.DEFAULT_IMAGE = null;
xt.DEFAULT_MAPPING = Na;
...
class Pl extends An {
  constructor(e = 1, t = 1, n = {}) {
    ...
    n.encoding !== void 0 &&
      ...
      (n.colorSpace = n.encoding === Mn ? at : wt)),
      (n = Object.assign(
        {
          generateMipmaps: !1,
          internalFormat: null,
...
class _i {
  ...
  intersectsTriangle(e) {
    ...
    return !_r(t, Ln, Dn, Un, Mi) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !_r(t, Ln, Dn, Un, Mi))
      ? !1
    ...
    return e.isEmpty()
      ...
      : (this.center.equals(e.center) === !0
          ...
          : (gr.subVectors(e.center, this.center).setLength(e.radius),
            this.expandByPoint(si.copy(e.center).add(gr)),
            this.expandByPoint(si.copy(e.center).sub(gr))),
        this);
  }
  equals(e) {
...
class Kr {
  ...
  distanceSqToSegment(e, t, n, r) {
    ...
    return (
      ...
      r && r.copy(vr).addScaledVector(Ei, d),
      m
    );
  }
  intersectSphere(e, t) {
...
class lt {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[3] = w * P + S * A + T * L + R * ie),
      (s[7] = w * b + S * W + T * H + R * K),
      (s[11] = w * k + S * Z + T * Y + R * q),
      (s[15] = w * x + S * J + T * V + R * D),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      p = e[14],
      h = e[15],
      w = f * p * c - g * d * c + g * l * m - a * p * m - f * l * h + a * d * h,
      S = v * d * c - u * p * c - v * l * m + o * p * m + u * l * h - o * d * h,
      T = u * g * c - v * f * c + v * a * m - o * g * m - u * a * h + o * f * h,
      R = v * f * l - u * g * l - v * a * d + o * g * d + u * a * p - o * f * p,
      P = t * w + n * S + r * T + s * R;
    if (P === 0)
...
class Ji {
  ...
  setFromQuaternion(e, t, n) {
    return (
      Xs.makeRotationFromQuaternion(e), this.setFromRotationMatrix(Xs, t, n)
    );
  }
...
class Tt extends An {
  ...
  remove(e) {
    ...
    return (
      t !== -1 &&
        ((e.parent = null), this.children.splice(t, 1), e.dispatchEvent(zl)),
      this
    );
  }
  removeFromParent() {
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ai, e, Fl), e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ai, Ol, e), e
    );
  }
  getWorldDirection(e) {
    this.updateWorldMatrix(!0, !1);
...
class Dt {
  ...
  static getBarycoord(e, t, n, r, s) {
    Pt.subVectors(r, t), Wt.subVectors(n, t), Sr.subVectors(e, t);
    const o = Pt.dot(Pt),
      a = Pt.dot(Wt),
      l = Pt.dot(Sr),
      c = Wt.dot(Wt),
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let o, a;
    Fn.subVectors(r, n), On.subVectors(s, n), Er.subVectors(e, n);
    const l = Fn.dot(Er),
      c = On.dot(Er);
    ...
    const g = m * c - l * v;
    if (g <= 0 && c >= 0 && v <= 0)
      return (a = c / (c - v)), t.copy(n).addScaledVector(On, a);
    const p = u * v - m * f;
    if (p <= 0 && f - u >= 0 && m - v >= 0)
      return (
        $s.subVectors(s, r),
        (a = (f - u) / (f - u + (m - v))),
        t.copy(r).addScaledVector($s, a)
      );
    const h = 1 / (p + g + d);
    return (
      (o = g * h),
      (a = d * h),
      t.copy(n).addScaledVector(Fn, o).addScaledVector(On, a)
    );
  }
  equals(e) {
...
class Qi extends An {
  constructor() {
    super(),
      ...
      (this.stencilFail = hr),
      (this.stencilZFail = hr),
      (this.stencilZPass = hr),
      (this.stencilWrite = !1),
...
class Ye {
  ...
  setHSL(e, t, n, r = Ve.workingColorSpace) {
    if (((e = qr(e, 1)), (t = ht(t, 0, 1)), (n = ht(n, 0, 1)), t === 0))
...
class bn extends An {
        ...
        for (let n = 0, r = t.length; n < r; n++) {
          ...
          Et.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (rt.addVectors(this.boundingBox.min, Et.min),
                this.boundingBox.expandByPoint(rt),
                rt.addVectors(this.boundingBox.max, Et.max),
                this.boundingBox.expandByPoint(rt))
      ...
      if ((Et.setFromBufferAttribute(e), t))
        for (let s = 0, o = t.length; s < o; s++) {
          ...
          oi.setFromBufferAttribute(a),
            this.morphTargetsRelative
              ? (rt.addVectors(Et.min, oi.min),
                Et.expandByPoint(rt),
                rt.addVectors(Et.max, oi.max),
                Et.expandByPoint(rt))
              : (Et.expandByPoint(oi.min), Et.expandByPoint(oi.max));
        }
      Et.getCenter(n);
      let r = 0;
        ...
        for (let s = 0, o = t.length; s < o; s++) {
          ...
          for (let c = 0, u = a.count; c < u; c++)
            rt.fromBufferAttribute(a, c),
              l && (Bn.fromBufferAttribute(e, c), rt.add(Bn)),
              (r = Math.max(r, n.distanceToSquared(rt)));
        }
  ...
  computeTangents() {
    ...
    function x(A) {
      ...
      const W = c[A];
      R.copy(W),
        R.sub(b.multiplyScalar(b.dot(W))).normalize(),
        P.crossVectors(k, W);
    ...
    if (s && a) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = a[l],
          f = s[l];
        u !== 0 &&
          (Rr.fromBufferAttribute(f, e),
          o ? Pi.addScaledVector(Rr, u) : Pi.addScaledVector(Rr.sub(t), u));
      }
      t.add(Pi);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        ...
        (dn.intersectSphere(Ci, Qs) === null ||
          dn.origin.distanceToSquared(Qs) > (e.far - e.near) ** 2)
      ) &&
        (Js.copy(s).invert(),
        dn.copy(e.ray).applyMatrix4(Js),
...
function Fi(i, e, t, n, r, s, o, a, l, c) {
  i.getVertexPosition(a, zn),
    i.getVertexPosition(l, Gn),
    i.getVertexPosition(c, Hn);
  const u = Vl(i, e, t, n, zn, Gn, Hn, Ii);
  if (u) {
    r &&
      (Li.fromBufferAttribute(r, a),
      Di.fromBufferAttribute(r, l),
      Ui.fromBufferAttribute(r, c),
      (u.uv = Dt.getInterpolation(Ii, zn, Gn, Hn, Li, Di, Ui, new Ne()))),
      s &&
        (Li.fromBufferAttribute(s, a),
        Di.fromBufferAttribute(s, l),
        Ui.fromBufferAttribute(s, c),
        (u.uv1 = Dt.getInterpolation(Ii, zn, Gn, Hn, Li, Di, Ui, new Ne())),
        (u.uv2 = u.uv1)),
      o &&
        (ea.fromBufferAttribute(o, a),
        ta.fromBufferAttribute(o, l),
        na.fromBufferAttribute(o, c),
        (u.normal = Dt.getInterpolation(Ii, zn, Gn, Hn, ea, ta, na, new N())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
    const f = { a, b: l, c, normal: new N(), materialIndex: 0 };
    Dt.getNormal(zn, Gn, Hn, f.normal), (u.face = f);
  }
  return u;
}
class Ut extends bn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, o = 1) {
    ...
    function v(g, p, h, w, S, T, R, P, b, k, x) {
      const A = T / b,
        W = R / k,
        Z = T / 2,
        J = R / 2,
...
class ql extends Tt {
  constructor(e, t, n) {
    ...
    const r = new Rt(Vn, kn, e, t);
    (r.layers = this.layers), this.add(r);
    const s = new Rt(Vn, kn, e, t);
    (s.layers = this.layers), this.add(s);
    const o = new Rt(Vn, kn, e, t);
    (o.layers = this.layers), this.add(o);
    const a = new Rt(Vn, kn, e, t);
    (a.layers = this.layers), this.add(a);
    const l = new Rt(Vn, kn, e, t);
    (l.layers = this.layers), this.add(l);
    const c = new Rt(Vn, kn, e, t);
...
class jl extends En {
  constructor(e = 1, t = {}) {
    ...
    t.encoding !== void 0 &&
      ...
      (t.colorSpace = t.encoding === Mn ? at : wt)),
      (this.texture = new Ja(
        r,
        t.mapping,
        t.wrapS,
...
class tn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = wr.subVectors(n, t).cross(Kl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || Zl.getNormalMatrix(e),
...
class Qa {
  ...
  setFromProjectionMatrix(e, t = jt) {
    ...
    if (
      ...
      n[2].setComponents(l + o, d + u, p + v, T + w).normalize(),
      n[3].setComponents(l - o, d - u, p - v, T - w).normalize(),
...
class $r extends bn {
  constructor(e = 1, t = 1, n = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let S = 0; S < c; S++) {
        const T = S * f - s;
        v.push(T, -w, 0), g.push(0, 0, 1), p.push(S / a), p.push(1 - h / l);
      }
    }
    for (let h = 0; h < l; h++)
      for (let w = 0; w < a; w++) {
        const S = w + c * h,
          ...
          R = w + 1 + c * (h + 1),
          P = w + 1 + c * h;
        m.push(S, T, P), m.push(T, R, P);
      }
    this.setIndex(m),
      this.setAttribute("position", new Sn(v, 3)),
      this.setAttribute("normal", new Sn(g, 3)),
...
#endif`,
  tc = `#ifdef USE_ALPHAMAP
	uniform sampler2D alphaMap;
#endif`,
  nc = `#ifdef USE_ALPHATEST
	if ( diffuseColor.a < alphaTest ) discard;
#endif`,
  ic = `#ifdef USE_ALPHATEST
...
#endif`,
  oc = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
	vec3 objectTangent = vec3( tangent.xyz );
#endif`,
  lc = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Sc = `vec3 transformedNormal = objectNormal;
...
void main() {
  ...
  Ie = {
    ...
    displacementmap_pars_vertex: Ec,
    ...
    envmap_fragment: wc,
    envmap_common_pars_fragment: Cc,
    envmap_pars_fragment: Pc,
    ...
    gradientmap_pars_fragment: Oc,
    lightmap_fragment: Bc,
    lightmap_pars_fragment: zc,
    lights_lambert_fragment: Gc,
    lights_lambert_pars_fragment: Hc,
...
function Ch(i, e, t, n, r, s, o) {
  ...
  function v(p, h) {
    ...
    S && S.isTexture && (S = (h.backgroundBlurriness > 0 ? t : e).get(S)),
      S === null ? g(a, l) : S && S.isColor && (g(S, 1), (w = !0));
    ...
    T === "additive"
      ...
      S && (S.isCubeTexture || S.mapping === Zi)
        ? (u === void 0 &&
            ((u = new gt(
              new Ut(1, 1, 1),
              new yn({
                name: "BackgroundCubeMaterial",
                uniforms: ei(Ot.backgroundCube.uniforms),
          ...
          (c === void 0 &&
            ((c = new gt(
              ...
              new yn({
                ...
                uniforms: ei(Ot.background.uniforms),
  ...
  function g(p, h) {
    p.getRGB(Bi, Za(i)), n.buffers.color.setClear(Bi.r, Bi.g, Bi.b, h, o);
  }
  return {
      ...
      if (B.location >= 0) {
        ...
        if (
          ...
          const Ce = Ee.buffer,
            ...
            st =
              n.isWebGL2 === !0 &&
              (xe === i.INT || xe === i.UNSIGNED_INT || ce.gpuType === Fa);
          if (ce.isInterleavedBufferAttribute) {
            ...
            if (De.isInstancedInterleavedBuffer) {
              for (let Me = 0; Me < B.locationSize; Me++)
                R(B.location + Me, De.meshPerAttribute);
              L.isInstancedMesh !== !0 &&
            ...
            if (ce.isInstancedBufferAttribute) {
              for (let De = 0; De < B.locationSize; De++)
                R(B.location + De, ce.meshPerAttribute);
              L.isInstancedMesh !== !0 &&
                V._maxInstanceCount === void 0 &&
...
function Ih(i) {
  let e = new WeakMap();
  function t(o, a) {
    return a === Fr ? (o.mapping = $n) : a === Or && (o.mapping = Jn), o;
  }
  function n(o) {
...
class aa {
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = oa(e, t, n));
  ...
  _sceneToCubeUV(e, t, n, r) {
    const a = new Rt(90, 1, t, n),
      ...
      f = u.autoClear,
      d = u.toneMapping;
    u.getClearColor(ra), (u.toneMapping = an), (u.autoClear = !1);
    const m = new qn({
  ...
  _halfBlur(e, t, n, r, s, o, a) {
    ...
    const u = 3,
      ...
      g = s / v,
      p = isFinite(s) ? 1 + Math.floor(u * g) : gn;
    p > gn &&
      console.warn(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${gn}`
      );
    const h = [];
    let w = 0;
    for (let b = 0; b < gn; ++b) {
    ...
    const T = this._sizeLods[r],
      R = 3 * T * (r > S - jn ? r - S + jn : 0),
      P = 4 * (this._cubeSize - T);
    zi(t, R, P, 3 * T, 2 * T), l.setRenderTarget(t), l.render(f, Cr);
  }
}
function Fh(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - jn + 1 + ia.length;
  for (let o = 0; o < s; o++) {
    const a = Math.pow(2, r);
    t.push(a);
    let l = 1 / a;
    o > i - jn ? (l = ia[o - i + jn - 1]) : o === 0 && (l = 0), n.push(l);
    const c = 1 / (a - 2),
      u = -c,
      f = 1 + c,
    ...
    for (let P = 0; P < m; P++) {
      ...
      w.set(x, g * v * P), S.set(d, p * v * P);
      const A = [P, P, P, P, P, P];
      T.set(A, h * v * P);
    }
    const R = new bn();
    R.setAttribute("position", new Bt(w, g)),
      R.setAttribute("uv", new Bt(S, p)),
      R.setAttribute("faceIndex", new Bt(T, h)),
      e.push(R),
      r > jn && r--;
  }
  ...
  function l(c, u, f) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== g) {
        ...
        (p = { count: g, texture: J, size: new Ne(A, W) }),
          s.set(u, p),
      ...
      f.getUniforms().setValue(i, "morphTargetBaseInfluence", w),
...
function Jh(i, e) {
  ...
  if (n === void 0) {
    ...
    if (tt(t, n)) return;
    da.set(n), i.uniformMatrix3fv(this.addr, !1, da), nt(t, n);
  }
}
function Qh(i, e) {
  const t = this.cache,
...
function Df(i, e, t) {
  const n = this.cache,
    ...
    s = er(t, r);
  tt(n, s) || (i.uniform1iv(this.addr, s), nt(n, s));
  for (let o = 0; o !== r; ++o) t.setTexture2DArray(e[o] || no, s[o]);
}
function Uf(i) {
  switch (i) {
    case 5126:
...
function Of(i, e, t) {
  ...
  for (Lr.lastIndex = 0; ; ) {
    ...
    if ((l && (a = a | 0), c === void 0 || (c === "[" && o + 2 === r))) {
      ma(t, c === void 0 ? new If(a, i, e) : new Nf(a, i, e));
      break;
    } else {
      let f = t.map[a];
      f === void 0 && ((f = new Ff(a)), ma(t, f)), (t = f);
    }
  }
}
class Vi {
...
`)),
      (h = [
        ...
        t.toneMapping !== an ? Vf("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const S = w + p + o,
    T = w + h + a,
    R = _a(r, r.VERTEX_SHADER, S),
    P = _a(r, r.FRAGMENT_SHADER, T);
  if (
    (r.attachShader(g, R),
    r.attachShader(g, P),
...
` +
  ...
  r.deleteShader(R), r.deleteShader(P);
  let b;
...
function ad(i, e, t, n, r, s, o) {
  ...
  function p(x, A, W, Z, J) {
    const L = Z.fog,
      ...
      ie = V && V.mapping === Zi ? V.image.height : null,
      K = v[x.type];
    x.precision !== null &&
    ...
    return (
        ...
        (ye = i.toneMapping),
      {
        ...
        emissiveMap: ke,
        normalMapObjectSpace: Pe && x.normalMapType === tl,
        normalMapTangentSpace: Pe && x.normalMapType === el,
        metalnessMap: Fe,
        roughnessMap: Le,
        anisotropy: He,
        anisotropyMap: O,
        ...
        metalnessMapUv: Fe && g(x.metalnessMap.channel),
        ...
        sheenRoughnessMapUv: C && g(x.sheenRoughnessMap.channel),
  ...
  function h(x) {
    ...
    return (
      x.isRawShaderMaterial === !1 &&
        (w(A, x), S(A, x), A.push(i.outputColorSpace)),
  ...
  function R(x, A) {
    ...
    return W === void 0 && ((W = new nd(i, A, x, s)), c.push(W)), W;
  }
  function P(x) {
    if (--x.usedTimes === 0) {
      const A = c.indexOf(x);
...
function Ta() {
  ...
  function c(f, d) {
    t.length > 1 && t.sort(f || ld),
      n.length > 1 && n.sort(d || Ea),
      r.length > 1 && r.sort(d || Ea);
  }
  function u() {
    ...
    for (let w = 0, S = u.length; w < S; w++) {
      ...
      if (T.isDirectionalLight) {
        ...
        R.position.setFromMatrixPosition(T.matrixWorld),
          ...
          o.premultiply(h),
          a.extractRotation(o),
          R.halfWidth.set(T.width * 0.5, 0, 0),
          R.halfHeight.set(0, T.height * 0.5, 0),
...
function md(i, e) {
  ...
  function n(s, o = 0) {
    ...
    return (
      a === void 0
        ? ((l = new ya(i, e)), t.set(s, [l]))
        : o >= a.length
        ? ((l = new ya(i, e)), a.push(l))
        : (l = a[o]),
      l
    );
  }
...
function Md(i, e, t) {
  ...
  this.render = function (R, P, b) {
    ...
    for (let L = 0, H = R.length; L < H; L++) {
      ...
      V.isPointLightShadow !== !0 && this.type === Yt && w(V, b),
        (V.needsUpdate = !1);
    }
  ...
  function w(R, P) {
    ...
    d.defines.VSM_SAMPLES !== R.blurSamples &&
      ...
      (d.needsUpdate = !0),
      (m.needsUpdate = !0)),
      R.mapPass === null && (R.mapPass = new En(r.x, r.y)),
    ...
    if (
      ...
      if (Array.isArray(J)) {
        ...
        for (let H = 0, Y = L.length; H < Y; H++) {
          ...
          if (ie && ie.visible) {
            const K = S(R, ie, k, x);
            i.renderBufferDirect(b, null, Z, K, R, V);
          }
        }
      } else if (J.visible) {
        const L = S(R, J, k, x);
        i.renderBufferDirect(b, null, Z, L, R, null);
      }
    }
    const W = R.children;
...
function Sd(i, e, t) {
  ...
  function o() {
    ...
    return {
      ...
      setFunc: function (We, Ft, ft) {
        (ne !== We || le !== Ft || ae !== ft) &&
          (i.stencilFunc(We, Ft, ft), (ne = We), (le = Ft), (ae = ft));
      },
      setOp: function (We, Ft, ft) {
        (j !== We || pe !== Ft || ye !== ft) &&
          (i.stencilOp(We, Ft, ft), (j = We), (pe = Ft), (ye = ft));
      },
  ...
  if (n) (I[us] = i.MIN), (I[hs] = i.MAX);
  else {
    const y = e.get("EXT_blend_minmax");
    y !== null && ((I[us] = y.MIN_EXT), (I[hs] = y.MAX_EXT));
  }
  const Qe = {
    [xo]: i.ZERO,
    [Mo]: i.ONE,
  ...
  function Me(y, se, ne, le, ae, j, pe, ye) {
    ...
    if ((h === !1 && (Ce(i.BLEND), (h = !0)), y !== _o)) {
      if (y !== w || ye !== x) {
        if (
          ((S !== Xn || P !== Xn) &&
            (i.blendEquation(i.FUNC_ADD), (S = Xn), (P = Xn)),
          ye)
        )
          switch (y) {
            case Kn:
        ...
        (T = null), (R = null), (b = null), (k = null), (w = y), (x = ye);
      }
      return;
    }
    (ae = ae || se),
...
function Ed(i, e, t, n, r, s, o) {
  ...
  function A(E) {
    return E === _t || E === fs || E === sr ? i.NEAREST : i.LINEAR;
  }
  function W(E) {
    const _ = E.target;
  ...
  const he = { [Br]: i.REPEAT, [It]: i.CLAMP_TO_EDGE, [zr]: i.MIRRORED_REPEAT },
    fe = {
      [_t]: i.NEAREST,
      [fs]: i.NEAREST_MIPMAP_NEAREST,
      [sr]: i.NEAREST_MIPMAP_LINEAR,
      [bt]: i.LINEAR,
      [Vo]: i.LINEAR_MIPMAP_NEAREST,
  ...
  function Ge(E, _, O) {
    ...
    if (ee.version !== _e.__version || $ === !0) {
      ...
      const re = Ve.getPrimaries(Ve.workingColorSpace),
        ...
        C = _.colorSpace === wt || re === ue ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, _.flipY),
        ...
        i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL, C);
      const te = R(_) && T(_.image) === !1;
  ...
  function st(E, _, O) {
    ...
    if ($.version !== ee.__version || Q === !0) {
      ...
      const C = _.isCompressedTexture || _.image[0].isCompressedTexture,
  ...
  function be(E) {
    ...
    if ($) {
      ...
      if (ee)
        if (r.drawBuffers) {
          const re = E.texture;
          for (let ue = 0, C = re.length; ue < C; ue++) {
      ...
      if (a && E.samples > 0 && He(E) === !1) {
        ...
        for (let ue = 0; ue < re.length; ue++) {
          ...
          const te = s.convert(C.format, C.colorSpace),
            X = s.convert(C.type),
            Te = k(
              C.internalFormat,
              te,
  ...
  function Fe(E) {
    if (a && E.samples > 0 && He(E) === !1) {
      ...
      for (let C = 0; C < _.length; C++) {
        ee.push(i.COLOR_ATTACHMENT0 + C), E.depthBuffer && ee.push(_e);
        const te =
        ...
        if (
          ...
          const X = n.get(_[C]).__webglTexture;
          i.framebufferTexture2D(
            i.DRAW_FRAMEBUFFER,
            i.COLOR_ATTACHMENT0,
            i.TEXTURE_2D,
      ...
      if (
        ...
        for (let C = 0; C < _.length; C++) {
          ...
          const te = n.get(_[C]).__webglTexture;
          t.bindFramebuffer(i.FRAMEBUFFER, re.__webglFramebuffer),
            i.framebufferTexture2D(
              i.DRAW_FRAMEBUFFER,
              i.COLOR_ATTACHMENT0 + C,
...
function Td(i, e, t) {
  ...
  function r(s, o = wt) {
    ...
    if (s === Oa) return i.UNSIGNED_SHORT_4_4_4_4;
    if (s === Ba) return i.UNSIGNED_SHORT_5_5_5_1;
    if (s === ko) return i.BYTE;
    if (s === Wo) return i.SHORT;
    if (s === Xr) return i.UNSIGNED_SHORT;
    if (s === Fa) return i.INT;
    ...
    if (s === Xo) return i.ALPHA;
    if (s === Nt) return i.RGBA;
    if (s === Yo) return i.LUMINANCE;
    if (s === qo) return i.LUMINANCE_ALPHA;
    if (s === xn) return i.DEPTH_COMPONENT;
    if (s === Qn) return i.DEPTH_STENCIL;
    if (s === Gr)
      return (a = e.get("EXT_sRGB")), a !== null ? a.SRGB_ALPHA_EXT : null;
    if (s === jo) return i.RED;
    if (s === za) return i.RED_INTEGER;
    if (s === Ko) return i.RG;
    if (s === Ga) return i.RG_INTEGER;
    if (s === Ha) return i.RGBA_INTEGER;
    if (s === ar || s === or || s === lr || s === cr)
      if (l === Xe)
        if (((a = e.get("WEBGL_compressed_texture_s3tc_srgb")), a !== null)) {
          if (s === ar) return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (s === or) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (s === lr) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
          if (s === cr) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
        } else return null;
      else if (((a = e.get("WEBGL_compressed_texture_s3tc")), a !== null)) {
        if (s === ar) return a.COMPRESSED_RGB_S3TC_DXT1_EXT;
        if (s === or) return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;
        if (s === lr) return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (s === cr) return a.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
    if (s === ds || s === ps || s === ms || s === _s)
...
class Rd extends An {
  constructor(e, t) {
    ...
    const R = new Rt();
    R.layers.enable(2), (R.viewport = new ot());
    const P = [T, R],
      b = new yd();
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (D) {
        let B = w[D];
        return (
          B === void 0 && ((B = new Dr()), (w[D] = B)), B.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (D) {
        let B = w[D];
        return B === void 0 && ((B = new Dr()), (w[D] = B)), B.getGripSpace();
      }),
      (this.getHand = function (D) {
        let B = w[D];
        return B === void 0 && ((B = new Dr()), (w[D] = B)), B.getHandSpace();
      });
    function A(D) {
    ...
    function W() {
      ...
      for (let D = 0; D < w.length; D++) {
        const B = S[D];
        B !== null && ((S[D] = null), w[D].disconnect(B));
      }
      (k = null),
        (x = null),
        e.setRenderTarget(p),
        ...
        if (((r = D), r !== null)) {
          if (
            ...
            (m = new XRWebGLLayer(r, t, B)),
              ...
              (h = new En(m.framebufferWidth, m.framebufferHeight, {
                format: Nt,
                type: on,
            ...
            (f = new XRWebGLBinding(r, t)),
              ...
              (h = new En(d.textureWidth, d.textureHeight, {
                format: Nt,
                type: on,
                depthTexture: new bd(
                  d.textureWidth,
    ...
    function Z(D) {
      for (let B = 0; B < D.removed.length; B++) {
        const ce = D.removed[B],
          he = S.indexOf(ce);
        he >= 0 && ((S[he] = null), w[he].disconnect(ce));
      }
    ...
    function H(D, B, ce) {
      ...
      const ke = Ce + Pe,
        ...
        et = ((Ge * xe) / Fe) * ke,
        it = ((st * xe) / Fe) * ke;
      D.projectionMatrix.makePerspective(Le, He, et, it, ke, Fe),
    ...
    this.updateCamera = function (D) {
      if (r === null) return;
      (b.near = R.near = T.near = D.near),
        (b.far = R.far = T.far = D.far),
        (k !== b.near || x !== b.far) &&
    ...
    (p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === vt && p.clearcoatNormalScale.value.negate())),
      h.iridescence > 0 &&
...
function Cd(i, e, t, n) {
  ...
  function c(w, S) {
    let T = r[w.id];
    T === void 0 &&
      (v(w), (T = u(w)), (r[w.id] = T), w.addEventListener("dispose", p));
    const R = S.program;
  ...
  function u(w) {
    ...
    return (
      ...
      i.bufferData(i.UNIFORM_BUFFER, R, P),
  ...
  function v(w) {
    ...
    for (let b = 0, k = S.length; b < k; b++) {
      ...
      if (
        ...
        P = T % R;
        const Z = R - P;
        P !== 0 && Z - A.boundary < 0 && ((T += R - P), (x.__offset = T));
      }
      T += A.storage;
    }
    return (
      (P = T % R), P > 0 && (T += R - P), (w.__size = T), (w.__cache = {}), this
    );
  }
  function g(w) {
...
class so {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${Wr}`),
    ...
    function me() {
      (Me = new zh(I)),
        ...
        (ke = new Vh(I)),
        (Fe = new od()),
        (Le = new Ed(I, Me, be, Fe, Pe, Te, ke)),
        (He = new Ih(S)),
        (et = new Bh(S)),
        (it = new $l(I, Pe)),
        (ge = new Ph(I, Me, it, Pe)),
        (E = new Gh(I, it, ke, ge)),
        (_ = new Yh(I, E, it, ke)),
        (C = new Xh(I, Pe, Le)),
        (_e = new Uh(Fe)),
        (O = new ad(S, He, et, Me, Pe, ge, _e)),
        (Q = new wd(S, Fe)),
        ($ = new cd()),
        (ee = new md(Me, Pe)),
        (ue = new Ch(S, He, et, be, _, d, l)),
        (re = new Md(S, _, Pe)),
        (ve = new Cd(I, ke, Pe, be)),
        (te = new Lh(I, Me, ke, Pe)),
        (X = new Hh(I, Me, ke, Pe)),
    ...
    (this.xr = y),
      ...
      (this.dispose = function () {
        t.removeEventListener("webglcontextlost", se, !1),
          ...
          y.removeEventListener("sessionend", Ft),
    ...
    (this.renderBufferDirect = function (M, U, z, F, G, de) {
      ...
      if (G.isInstancedMesh) Ze.renderInstances(qe, yt, G.count);
        ...
        const ze = z._maxInstanceCount !== void 0 ? z._maxInstanceCount : 1 / 0,
          tr = Math.min(z.instanceCount, ze);
        Ze.renderInstances(qe, yt, tr);
    ...
    ft.setAnimationLoop(Ke),
      ...
      y.addEventListener("sessionend", Ft),
    ...
    function es(M, U, z, F) {
      ...
      const de = M.children;
      for (let Se = 0, Re = de.length; Se < Re; Se++) es(de[Se], U, z, F);
    }
    function ts(M, U, z, F) {
      const G = M.opaque,
        de = M.transmissive,
    ...
    function gi(M, U, z) {
      ...
      for (let G = 0, de = M.length; G < de; G++) {
        const Se = M[G],
          ...
          Ae = Se.group;
        Re.layers.test(z.layers) && ns(Re, U, z, we, Be, Ae);
      }
    }
    function ns(M, U, z, F, G, de) {
    ...
    function lo(M, U, z, F, G) {
      ...
      F.version === ze.__version
        ? ((ze.needsLights && ze.lightsStateVersion !== tr.state.version) ||
      ...
      const dt = cn.getUniforms(),
        un = ze.uniforms;
      if (
        (be.useProgram(cn.program) && ((rs = !0), (ii = !0), (nr = !0)),
        F.id !== k && ((k = F.id), (ii = !0)),
        rs || x !== M)
      ) {
        dt.setValue(I, "projectionMatrix", M.projectionMatrix),
          dt.setValue(I, "viewMatrix", M.matrixWorldInverse);
        const Mt = dt.map.cameraPosition;
        Mt !== void 0 &&
          Mt.setValue(I, Ge.setFromMatrixPosition(M.matrixWorld)),
        ...
        Mt &&
          (Pe.floatVertexTextures
            ? (Mt.boneTexture === null && Mt.computeBoneTexture(),
              dt.setValue(I, "boneTexture", Mt.boneTexture, Le),
              dt.setValue(I, "boneTextureSize", Mt.boneTextureSize))
            : console.warn(
                "THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."
              ));
      }
      const ir = z.morphAttributes;
      if (
        ((ir.position !== void 0 ||
          ir.normal !== void 0 ||
          (ir.color !== void 0 && Pe.isWebGL2 === !0)) &&
          C.update(G, z, cn),
        (ii || ze.receiveShadow !== G.receiveShadow) &&
        ...
        for (let rr = 0, ho = Mt.length; rr < ho; rr++)
          if (Pe.isWebGL2) {
            const ss = Mt[rr];
            ve.update(ss, cn), ve.bind(ss, cn);
          } else
            console.warn(
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (M, U, z) {
        (Fe.get(M.texture).__webglTexture = U),
      ...
      (this.setRenderTarget = function (M, U = 0, z = 0) {
        ...
        if (M) {
          ...
          (Be.isData3DTexture ||
            ...
            (Se = !0);
          const Ae = Fe.get(M).__webglFramebuffer;
      ...
      (this.readRenderTargetPixels = function (M, U, z, F, G, de, Se) {
        ...
        let Re = Fe.get(M).__webglFramebuffer;
        if ((M.isWebGLCubeRenderTarget && Se !== void 0 && (Re = Re[Se]), Re)) {
          ...
          try {
            ...
            const we = b !== null ? Fe.get(b).__webglFramebuffer : null;
      ...
      (this.resetState = function () {
        (R = 0), (P = 0), (b = null), be.reset(), ge.reset();
      }),
  ...
  set outputColorSpace(e) {
    ...
    (t.drawingBufferColorSpace = e === Yr ? "display-p3" : "srgb"),
      (t.unpackColorSpace =
        Ve.workingColorSpace === $i ? "display-p3" : "srgb");
  }
  ...
  get outputEncoding() {
    return (
      ...
      this.outputColorSpace === at ? Mn : Va
    );
  }
  set outputEncoding(e) {
    console.warn(
      ...
      (this.outputColorSpace = e === Mn ? at : Kt);
  }
  get useLegacyLights() {
    return (
      console.warn(
...
Qr.DEFAULT_MATERIAL_NAME = "__DEFAULT";
class Id extends Qr {
  constructor(e) {
    super(e);
  }
  load(e, t, n, r) {
    ...
    const a = mi("img");
    function l() {
      u(), Aa.add(e, this), t && t(this), s.manager.itemEnd(e);
    }
    function c(f) {
...
class Fd {
  ...
  intersectObject(e, t = !0, n = []) {
    return kr(e, this, n, t), n.sort(ba), n;
  }
  intersectObjects(e, t = !0, n = []) {
    for (let r = 0, s = e.length; r < s; r++) kr(e[r], this, n, t);
    return n.sort(ba), n;
  }
}
function ba(i, e) {
...
function kr(i, e, t, n) {
  if ((i.layers.test(e.layers) && i.raycast(e, t), n === !0)) {
    const r = i.children;
    for (let s = 0, o = r.length; s < o; s++) kr(r[s], e, t, !0);
  }
}
class Ra {
...
typeof __THREE_DEVTOOLS__ < "u" &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent("register", { detail: { revision: Wr } })
  );
typeof window < "u" &&
  (window.__THREE__
  ...
  constructor(e, t) {
    super(),
      ...
      (this.listenToKeyEvents = function (C) {
        C.addEventListener("keydown", _), (this._domElementKeyEvents = C);
      }),
      ...
      (this.update = (function () {
        const C = new N(),
          te = new Tn().setFromUnitVectors(e.up, new N(0, 1, 0)),
          X = te.clone().invert(),
          Te = new N(),
          ge = new Tn(),
          ve = new N(),
        ...
        return function (se = null) {
          ...
          C.copy(ne).sub(n.target),
            C.applyQuaternion(te),
            a.setFromVector3(C),
              ...
              (this.screenSpacePanning
                ...
                : (Hi.origin.copy(n.object.position),
                  Hi.direction
                    .set(0, 0, -1)
                    .transformDirection(n.object.matrix),
                  Math.abs(n.object.up.dot(Hi.direction)) < Od
                    ? e.lookAt(n.target)
                    : (Pa.setFromNormalAndCoplanarPoint(n.object.up, n.target),
                      Hi.intersectPlane(Pa, n.target))));
          } else
    ...
    const J = (function () {
        ...
        return function (X, Te) {
          C.setFromMatrixColumn(Te, 0), C.multiplyScalar(-X), u.add(C);
        };
      })(),
      L = (function () {
        const C = new N();
        return function (X, Te) {
          n.screenSpacePanning === !0
            ...
            : (C.setFromMatrixColumn(Te, 0), C.crossVectors(n.object.up, C)),
            C.multiplyScalar(X),
            u.add(C);
        };
      })(),
    ...
    function D(C) {
      ie(C), h.set(C.clientX, C.clientY);
    }
    function B(C) {
    ...
    function Ee(C) {
      ie(C), C.deltaY < 0 ? V(A()) : C.deltaY > 0 && Y(A()), n.update();
    }
    function Ce(C) {
      let te = !1;
      switch (C.code) {
    ...
    function Pe(C) {
      ...
      w.set(0, ge),
        S.set(0, Math.pow(w.y / h.y, n.zoomSpeed)),
        Y(S.y),
        h.copy(w);
    }
    function be(C) {
    ...
    function ke(C) {
      n.enableZoom && Pe(C), n.enableRotate && Qe(C);
    }
    function Fe(C) {
      n.enabled !== !1 &&
        (b.length === 0 &&
        ...
        ee(C),
        C.pointerType === "touch" ? O(C) : et(C));
    }
    function Le(C) {
      n.enabled !== !1 && (C.pointerType === "touch" ? Q(C) : it(C));
    }
    function He(C) {
      _e(C),
        b.length === 0 &&
    ...
    function E(C) {
      n.enabled === !1 ||
        n.enableZoom === !1 ||
        s !== r.NONE ||
        (C.preventDefault(), n.dispatchEvent(Ur), Ee(C), n.dispatchEvent(Ca));
    }
    function _(C) {
      n.enabled === !1 || n.enablePan === !1 || Ce(C);
    }
    function O(C) {
      switch ((re(C), b.length)) {
        case 1:
    ...
    function _e(C) {
      ...
      for (let te = 0; te < b.length; te++)
        if (b[te].pointerId == C.pointerId) {
          b.splice(te, 1);
          return;
        }
    }
    function re(C) {
      let te = k[C.pointerId];
      te === void 0 && ((te = new Ne()), (k[C.pointerId] = te)),
        te.set(C.pageX, C.pageY);
    }
    function ue(C) {
      const te = C.pointerId === b[0].pointerId ? b[1] : b[0];
...
const ji = new so(),
  Ir = new Nd(),
  _n = new Ld(),
  Ki = new Rt(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  Lt = new Bd(Ki, ji.domElement),
  ao = () => {
    requestAnimationFrame(ao), Lt.update(), ji.render(_n, Ki);
  },
  zd = () => {
    (Lt.enableDamping = !0),
      ...
      Ki.position.set(0, 1, 4),
      Lt.update();
    const i = Ir.load("./basement-floor.png"),
      e = new Ut(6, 0.1, 6),
      t = new qn({ map: i }),
      n = new gt(e, t);
    _n.add(n);
    const r = new Ut(0.2, 0.2, 1),
      s = new qn({ color: 9858867 }),
      o = new gt(r, s),
      a = Ir.load("./basement-ceiling.png"),
      l = new Ut(6, 0.1, 6),
      c = new qn({ map: a }),
      u = new gt(l, c);
    _n.add(u);
    const f = new Ut(6, 2, 0.1),
      d = new Ut(0.1, 2, 6),
      m = new Ut(0.1, 2, 6),
      v = Ir.load("./basement-wall.jpeg"),
      g = new qn({ map: v }),
      p = new gt(f, g),
      h = new gt(d, g),
      w = new gt(m, g);
    p.position.set(0, 1, -3),
      h.position.set(3, 1, 0),
      w.position.set(-3, 1, 0),
      u.position.set(0, 2, 0),
      o.position.set(-1.5, 0.2, 0),
      _n.add(p),
      _n.add(h),
      _n.add(w),
      _n.add(o);
    ...
    document.addEventListener("click", (R) => {
      if (
        ((T.x = (R.clientX / window.innerWidth) * 2 - 1),
        (T.y = -(R.clientY / window.innerHeight) * 2 + 1),
        S.setFromCamera(T, Ki),
        S.intersectObjects([o]).length > 0)
      ) {
        alert("You found an axe!");
        const b = document.getElementById("basement-option-2"),
          k = document.getElementById("basement-option-3"),
          l = document.getElementById("dialog-container"),
          m = document.getElementById("basement-end-game");
